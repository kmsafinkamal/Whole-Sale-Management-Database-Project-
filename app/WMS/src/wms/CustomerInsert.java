...
public class CustomerInsert extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Insert Customer Details");

        jLabel2.setText("Customer_ID");

        jLabel3.setText("Customer_name");

        jLabel4.setText("street_no");

        jLabel5.setText("City");

        jLabel6.setText("State");

        jLabel7.setText("Birth_date");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String street_no = jTextField3.getText();
        String City = jTextField4.getText();
        String State = jTextField5.getText();
        String Birth_date = jTextField6.getText();
        
        try {
            String QUERY = "INSERT INTO `wholesalemanagementsystem`.`customer` (`Customer_ID`, `Customer_name`, `street_no`, `City`, `State`, `Birth_date`) VALUES ('"
                    + Customer_ID
                    + "', '"
                    + Customer_name
                    + "', '"
           ...
           Class.forName("com.mysql.jdbc.Driver"); //Register the mysql driver
            Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/wholesalemanagementsystem","root","priyanka13579");
